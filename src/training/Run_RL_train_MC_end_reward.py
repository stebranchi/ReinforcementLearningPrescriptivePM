...
def main():
    ...
    input_file = os.path.join("..", "..", "cluster_data", "output_mdps", "BPI2012_50_positional_cumulative_squashed_training_80_preprocessed.csv")
    output_file = os.path.join("..", "..", "cluster_data", "output_policies", "BPI2012_log_eng_positional_prova_header.csv")
