...
def main():
    ...
    input_file = os.path.join("..", "final_evaluation", "Fine", "Mdp", "Trimmed Traffic_Fine mdp training r3 80.csv")
    output_file = os.path.join("..", "final_evaluation", "Fine", "Output", "Trimmed Traffic_Fine mdp training r3 80 policy.csv")
    ...
    gamma = 0.95 # discount rate, discount near to 1 avoids loops
